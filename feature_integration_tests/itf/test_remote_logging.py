...
_LINUX_LOGGINGAPP_START_CMD = "cd /showcases/data/logging/logging_app/etc && nohup /showcases/bin/logging_app &"
...
def test_remote_logging(datarouter_running, target, dlt_config):
    ...
    with DltWindow(
        ...
        exit_code, out = target.execute(_LINUX_LOGGINGAPP_START_CMD)
